...
smpsHeaderStartSong = 1
	smpsHeaderVoice     DashSFX_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $02

	smpsHeaderSFXChannel cFM4, DashSFX_FM6,	$00, $0A
	smpsHeaderSFXChannel cFM5, DashSFX_FM5,	$00, $00
...
DashSFX_Loop01:
	dc.b	nG0, $0F
	smpsLoop            $00, $03, DashSFX_Loop01

DashSFX_Loop02:
	dc.b	nG0, $0A
	smpsFMAlterVol      $05
	smpsLoop            $00, $06, DashSFX_Loop02
	smpsStop
