...
smpsHeaderStartSong = 1
	smpsHeaderVoice     TallySFX_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $03

	smpsHeaderSFXChannel cFM3, TallySFX_FM3,	$F5, $08
	smpsHeaderSFXChannel cFM5, TallySFX_FM5,	$00, $00
	smpsHeaderSFXChannel cFM4, TallySFX_FM6,	$00, $00
