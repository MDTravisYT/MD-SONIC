...
PSG_Index:
		dc.l PSG1, PSG2, PSG3
		dc.l PSG4, PSG5, PSG6
		dc.l PSG7, PSG8, PSG9, PSGA
PSG1:		incbin	"sound driver/psg/psg1.bin"
PSG2:		incbin	"sound driver/psg/psg2.bin"
PSG3:		incbin	"sound driver/psg/psg3.bin"
PSG4:		incbin	"sound driver/psg/psg4.bin"
PSG6:		incbin	"sound driver/psg/psg6.bin"
PSG5:		incbin	"sound driver/psg/psg5.bin"
PSG7:		incbin	"sound driver/psg/psg7.bin"
PSG8:		incbin	"sound driver/psg/psg8.bin"
PSG9:		incbin	"sound driver/psg/psg9.bin"
PSGA:		incbin	"sound driver/psg/psgA.bin"
; ---------------------------------------------------------------------------
...
; SoundTypes:
SoundPriorities:
		dc.b $90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90	; $81
		dc.b $90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90	; $90
		dc.b $90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90	; $A0
...
Sound_PlaySFX:
		...
		bne.w	.clear_sndprio		; Exit if it is
		cmpi.b	#SFXRingRight,d7		; is ring sound	effect played?
		...
		move.b	#SFXRingLeft,d7	; play ring sound in left speaker
; loc_721EE:
.gotringspeaker:
...
; ---------------------------------------------------------------------------
	...
	include		"sound driver/_smps2asm_inc.asm"

Music81:	;include	"sound driver/music/R1B.asm"
			incbin	"sound driver/music/Mus82 - LZ.bin"
		even
Music82:	incbin	"sound driver/music/Mus81 - GHZ.bin"
		even
Music83:	incbin	"sound driver/music/Mus86 - SBZ.bin"
		even
Music84:	incbin	"sound driver/music/Mus85 - SYZ.bin"
		even
Music85:
Music86:
Music87:	incbin	"sound driver/music/Mus87 - Invincibility.bin"
		even
Music88:	incbin	"sound driver/music/Mus88 - Extra Life.bin"
		even
Music89:
Music8A:	incbin	"sound driver/music/Mus8A - Title Screen.bin"
		even
Music8B:
Music8C:
			incbin  "sound driver/music/Mus8C - Boss.bin"
Music8D:
Music8E:	incbin	"sound driver/music/Mus8E - Sonic Got Through.bin"
		even
Music8F:	incbin	"sound driver/music/Mus8F - Game Over.bin"
		even
Music90:
Music91:
Music92:
...
; ---------------------------------------------------------------------------
SoundIndex:
ptr_snd90:	dc.l Sound90
ptr_snd91:	dc.l Sound91
ptr_snd92:	dc.l Sound92
ptr_snd93:	dc.l Sound93
ptr_snd94:	dc.l Sound94
ptr_snd95:	dc.l Sound95
ptr_snd96:	dc.l Sound96
ptr_snd97:	dc.l Sound97
ptr_snd98:	dc.l Sound98
ptr_snd99:	dc.l Sound99
ptr_snd9A:	dc.l Sound9A
ptr_snd9B:	dc.l Sound9B
ptr_snd9C:	dc.l Sound9C
ptr_snd9D:	dc.l Sound9D
ptr_snd9E:	dc.l Sound9E
ptr_snd9F:	dc.l Sound9F
...
; Sound effect data
; ---------------------------------------------------------------------------
Sound90:	include	"sound driver/sfx/Skid.asm"
		even
Sound91:	include	"sound driver/sfx/Dash.asm"
		even
Sound92:	include	"sound driver/sfx/Jump.asm"
		even
Sound93:	include	"sound driver/sfx/Die.asm"
		even
Sound94:	include	"sound driver/sfx/Loss.asm"
		even
Sound95:	include	"sound driver/sfx/RingR.asm"
		even
Sound96:	include	"sound driver/sfx/Destroy.asm"
		even
Sound97:	include	"sound driver/sfx/shield.asm"
		even
Sound98:	include	"sound driver/sfx/spring.asm"
		even
Sound99:	include	"sound driver/sfx/button.asm"
		even
Sound9A:	include	"sound driver/sfx/tally.asm"
		even
Sound9B:	include	"sound driver/sfx/rollfade.asm"
		even
Sound9C:	include	"sound driver/sfx/rollcont.asm"
		even
Sound9D:	include	"sound driver/sfx/signpost.asm"
		even
Sound9E:	include	"sound driver/sfx/explosion.asm"
		even
Sound9F:	include	"sound driver/sfx/pop.asm"
		even
SoundA0:	include	"sound driver/sfx/noisepop.asm"
		even
SoundA1:	include	"sound driver/sfx/idk.asm"
		even
SoundA2:	include	"sound driver/sfx/splash.asm"
		even
SoundA3:	include	"sound driver/sfx/crumble.asm"
		even
SoundA4:	include	"sound driver/sfx/door.asm"
		even
SoundA5:	include	"sound driver/sfx/unused.asm"
		even
SoundA6:	include	"sound driver/sfx/waterfall.asm"
		even
SoundA7:	include	"sound driver/sfx/thorn.asm"
		even
SoundA8:	include	"sound driver/sfx/RingL.asm"
		even
SoundA9:	include	"sound driver/sfx/Travel.asm"
		even
SoundAA:	include	"sound driver/sfx/rolljam.asm"
		even
SoundAB:	include	"sound driver/sfx/Stop.asm"
		even
SoundAC:	incbin	"sound driver/sfx/boing.bin"
		even
SoundAD:	include	"sound driver/sfx/pound.asm"
		even
