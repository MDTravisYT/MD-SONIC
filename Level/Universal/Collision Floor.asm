...
.Blank:
	lea		LevelChunks,a2	;	(pointer's now RAM)
	add.l  (a2),d1			;	(pointer's now RAM)
...
.LoopChunk:
	...
	beq.s   .GetBlock
	addq.w  #1,d1
	cmpi.w  #$29,d1     ; Is this chunk $29?
	bne.s   .GetBlock   ; If not, branch
	move.w  #$51,d1     ; Change it to chunk $51
...
FindLevelFloor:
	...
	lea		LevelChunks,a2	;	(pointer's now RAM)
	cmp.l  (a2),d1			;	(pointer's now RAM) Is it a blank block?
